...
namespace BigBlueIsYou.Entities
{
  public class WallEntity : IEntity
  {
    ...
    public WallEntity(int productionNumber)
    {
      Id = Guid.NewGuid();
      Components = new List<IComponent>();
      Name = "Wall" + productionNumber;
    }

    public WallEntity(List<IComponent> Components, string Name)
    {
      Id = Guid.NewGuid();
    ...
    public IEntity Clone()
    {
      ...
      return new WallEntity(ClonedComponents, Name);
    }
  }
}
