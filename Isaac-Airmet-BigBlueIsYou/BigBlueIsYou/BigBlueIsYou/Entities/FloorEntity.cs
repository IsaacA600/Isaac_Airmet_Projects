...
namespace BigBlueIsYou.Entities
{
    public class FloorEntity : IEntity
    {
        ...
        public FloorEntity(int productionNumber)
        {
            Id = Guid.NewGuid();
            Components = new List<IComponent>();
            Name = "Floor" + productionNumber;
        }

        public FloorEntity(List<IComponent> Components, string Name)
        {
            Id = Guid.NewGuid();
        ...
        public IEntity Clone()
        {
            ...
            return new FloorEntity(ClonedComponents, Name);
        }
    }
}
